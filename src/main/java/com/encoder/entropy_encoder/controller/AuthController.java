...
import com.encoder.entropy_encoder.exception.AppException;
import com.encoder.entropy_encoder.model.Role;
import com.encoder.entropy_encoder.model.RoleName;
import com.encoder.entropy_encoder.model.User;
import com.encoder.entropy_encoder.payload.APIResponse;
import com.encoder.entropy_encoder.payload.JWTAuthenticationResponse;
import com.encoder.entropy_encoder.payload.LoginRequest;
import com.encoder.entropy_encoder.payload.SignUpRequest;
import com.encoder.entropy_encoder.repository.RoleRepository;
import com.encoder.entropy_encoder.repository.UserRepository;
import com.encoder.entropy_encoder.security.CurrentUser;
import com.encoder.entropy_encoder.security.JWTTokenProvider;
...
public class AuthController {
    ...
    @GetMapping("/profile")
    public User me(@CurrentUser UserPrincipal userPrincipal){
        User user = userRepository.findByUsername(userPrincipal.getUsername()).get();
        return user;
    }
}
